...
def final_subscription():
    ...
    if request.method =="POST":
        Mes_1 = DrawingTransfer("20210102", "000723", str_count, "4d60bf5b7376fdca75b5a61080c2f5a3e55e21562757c12fad2ee736075f3d28", "00820100007230000000000004841", "29700", "베이직")
        # flash(Mes_1)
        count += 1
        msg_1=Mes_1
        str_count = str(count).zfill(4)
        Mes_2 = InquireBalance("20210102", "000723", str_count, "4d60bf5b7376fdca75b5a61080c2f5a3e55e21562757c12fad2ee736075f3d28", "00820100007230000000000004841")
        count += 1
